      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {highlights.map((item, index) => (
            <div
              key={item.title}
              className="text-center p-6 lg:p-8 rounded-xl bg-white border border-warm-gray-100 hover:border-gold/30 hover:shadow-lg transition-all duration-400"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center mx-auto mb-4 text-purple-600">
                {item.icon}
              </div>
              <h3 className="text-sm font-semibold text-plum mb-2 uppercase tracking-wide" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
                {item.title}
              </h3>
