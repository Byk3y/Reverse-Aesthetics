            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-bronze/10 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-warm-gray-400 font-light">09159188094</p>
                    <p className="text-sm text-warm-gray-400">Mon-Sat 9:00 AM-7:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-warm-gray-400 font-light">reverseaestheticsng@gmail.com</p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-warm-gray-50 border border-warm-gray-100 flex items-center justify-center hover:bg-charcoal hover:text-white hover:border-charcoal transition-colors duration-300"
                  >
          ...
          >
            <form onSubmit={handleSubmit} className="bg-white border border-warm-gray-100 p-8">
              ...
              <div className="space-y-5">
                <div>
                  <label htmlFor="name" className="block text-[11px] font-medium uppercase tracking-[0.25em] text-bronze mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 border border-warm-gray-100 rounded-sm focus:ring-2 focus:ring-bronze focus:border-transparent transition-all duration-200"
                    placeholder="John Doe"
                  />
                </div>

                <div>
                  <label htmlFor="email" className="block text-[11px] font-medium uppercase tracking-[0.25em] text-bronze mb-2">
                    Email Address *
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-[11px] font-medium uppercase tracking-[0.25em] text-bronze mb-2">
                    Phone Number
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="service" className="block text-[11px] font-medium uppercase tracking-[0.25em] text-bronze mb-2">
                    Interested In
                  </label>
                  <select
                    id="service"
                ...
                <div>
                  <label htmlFor="message" className="block text-[11px] font-medium uppercase tracking-[0.25em] text-bronze mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
                    ...
                    required
                    rows={4}
                    className="w-full px-4 py-3 border border-warm-gray-100 rounded-sm focus:ring-2 focus:ring-bronze focus:border-transparent transition-all duration-200 resize-none"
                ...
                <button
                  ...
                  className="w-full bg-charcoal text-white py-4 hover:bg-charcoal/90 transition-colors duration-300 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? 'Sending...' : 'Send Message'}
                </button>

                <p className="text-sm text-warm-gray-400 text-center font-light">
