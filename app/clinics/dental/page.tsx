          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-white p-8 lg:p-10 rounded-2xl border border-warm-gray-100 shadow-sm group hover:shadow-lg transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="text-xs uppercase tracking-wider bg-purple-50 text-purple-800 px-3 py-1 rounded-full">Cosmetic</span>
                <span className="text-xs uppercase tracking-wider bg-gold/10 text-gold-dark px-3 py-1 rounded-full">1 Hour</span>
              </div>
              <div className="flex items-center justify-between border-t border-warm-gray-100 pt-6">
                <span className="text-plum font-semibold">From ₦80,000</span>
            ...
            <div className="bg-white p-8 lg:p-10 rounded-2xl border border-warm-gray-100 shadow-sm group hover:shadow-lg transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="text-xs uppercase tracking-wider bg-purple-50 text-purple-800 px-3 py-1 rounded-full">Hygiene</span>
                <span className="text-xs uppercase tracking-wider bg-gold/10 text-gold-dark px-3 py-1 rounded-full">Routine</span>
              </div>
              <div className="flex items-center justify-between border-t border-warm-gray-100 pt-6">
                <span className="text-plum font-semibold">From ₦35,000</span>
                <Link href="/booking" className="text-gold font-medium group-hover:text-purple-600 transition-colors uppercase tracking-wider text-sm flex items-center">
                  Book Consult
                  <span className="ml-2 transform group-hover:translate-x-1 transition-transform">→</span>
                </Link>
