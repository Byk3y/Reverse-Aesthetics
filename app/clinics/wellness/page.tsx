...
export const metadata = {
  ...
  alternates: { canonical: "/clinics/wellness" },
};
...
const DRIPS = [
  {
    title: "The Reverse Signature Glow",
    body: "Our most popular aesthetic drip. Packed with high-dose Vitamin C and Glutathione to detoxify the liver, inhibit melanin production, and give your skin a luminous, even tone.",
    tags: ["Skin Brightening", "Detox"],
    price: "From ₦75,000",
    href: "/treatments/iv-glow-therapy-lagos",
  },
  {
    title: "NAD+ Anti-Aging Infusion",
    body: "The “fountain of youth” coenzyme. NAD+ repairs DNA, restores neurological function, improves mental clarity, and combats chronic fatigue at the cellular level.",
    tags: ["Anti-Aging", "Cellular Health"],
    price: "From ₦150,000",
    href: "/treatments/iv-glow-therapy-lagos",
  },
];
      ...
      <section className="relative overflow-hidden bg-[var(--color-clinic-hero-top)]">
        ...
        <div className="mx-auto max-w-[820px] px-[20px] pb-[54px] pt-[18px] text-center md:pb-[72px] md:pt-[30px]">
          ...
          <h1 className="hero-copy-reveal [animation-delay:120ms] mx-auto max-w-[760px] text-[32px] font-semibold leading-[1.12] tracking-[-0.02em] text-[var(--color-clinic-navy)] md:text-[52px] md:leading-[1.08]">
            Beauty begins from{" "}
            <span className="text-[var(--color-clinic-hero-accent)]">Within</span>
            .
          </h1>
