        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/treatments/iv-glow-therapy-lagos" className="group p-8 border border-warm-gray-100 bg-white hover:bg-ivory transition-all duration-300">
              <h3 className="text-xl text-charcoal font-light mb-3 group-hover:text-bronze transition-colors duration-300" style={{ fontFamily: "var(--font-display), sans-serif" }}>IV Glow Therapy</h3>
